...
namespace UCP1_PAW_017_A.Controllers
{
    public class ProduksController : Controller
    {
        ...
        public ProduksController(MilkDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProduk,NamaProduk,HargaProduk")] Produk produk)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProduk,NamaProduk,HargaProduk")] Produk produk)
        {
